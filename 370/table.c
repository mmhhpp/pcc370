...
UNARY MINUS, INAREG,
 SAREG, TINT|TUNSIGNED|TCHAR|TUCHAR|TLONG|TULONG,
 SANY,  TANY,
  NAREG, RESC1,
/*   "  lr  A1,AL  cmpl1a\n  slr  AL,AL  cmpl1b\n  sr  AL,A1  cmpl1c\n", */
  "  lr  A1,AL  cmpl1a\n  lcr  A1,A1  cmpl1b\n",
...
UNARY MINUS, INTAREG,
 STAREG, TINT|TUNSIGNED|TCHAR|TUCHAR|TLONG|TULONG,
 SANY,  TANY,
  NAREG, RLEFT,
  "  lr  A1,AL  cmpl2a\n  slr  AL,AL  cmpl2b\n  sr  AL,A1  cmpl2c\n",
...
SCONV,  INBREG|INTBREG,
 SAREG | STAREG, TINT|TLONG,
 SANY,   TDOUBLE,
 NAREG | NBREG | NTEMP * 2,      RESC2,
         " lr A1,AL sconv3r\nZi",

SCONV,  INBREG|INTBREG,
 SOREG | SNAME, TINT|TLONG,
 SANY,   TDOUBLE,
 NAREG | NBREG | NTEMP * 2,      RESC2,
         " l A1,AL sconv3l\nZi",

SCONV,  INBREG|INTBREG,
 SANY, TUNSIGNED|TULONG,
 SANY,   TDOUBLE,
 NAREG | NBREG | NTEMP * 4,      RESC2,
         "Zu",
...
SCONV,  INAREG|INTAREG,
 SBREG | STBREG,   TDOUBLE,
 SANY, TINT|TLONG|TCHAR|TUCHAR,
 NAREG | NBREG | NTEMP * 2,      RESC1,
         "* zj al=AL a1=A1 a2=A2\nZj",
...
SCONV,  INTAREG,
 SAREG|STAREG,   TSHORT|TINT|TLONG,
 SANY, TUCHAR,
         NAREG,      RESC1,
         " lr A1,AL sconv6\n n A1,=x'000000ff' sconv6a\n",
