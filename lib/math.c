...
static double ln2 = 0.69314718055994530941723212145818 ;


__PDPCLIB_API__ double ceil(x) double x;
{
    int y;
...
#undef fabs
#endif
__PDPCLIB_API__ double fabs(x) double x;
{
    if (x < 0.0)
    {
        x = -x;
...
__PDPCLIB_API__ double floor(x) double x;
{
    int y;
...
__PDPCLIB_API__ double fmod(x, y) double x; double y;
{
    int imod;
    if(y == 0.0) return (0.0);
    imod = x / y;
...
*/
__PDPCLIB_API__ double acos(x) double x;
{
...
__PDPCLIB_API__ double asin (y) double y;
{
    int i;
...
__PDPCLIB_API__ double atan (x) double x;
{
    int i;
...
__PDPCLIB_API__ double atan2(y,x) double y; double x;
{
    return (x >= y) ?
...
#undef cos
#endif
__PDPCLIB_API__ double cos(x) double x;
{
/*
...
#undef sin
#endif
__PDPCLIB_API__ double sin(x) double x;
{
/*
...
#undef tan
#endif
__PDPCLIB_API__ double tan (x) double x;
{
/*
...
*/
__PDPCLIB_API__ double cosh(x) double x;
{
    double dexpx;
...
__PDPCLIB_API__ double sinh(x) double x;
{
    double dexpx;
...
__PDPCLIB_API__ double tanh(x) double x;
{
    double dexp2;
...
*/
__PDPCLIB_API__ double exp (x) double x;
{
    int i;
...
*/
__PDPCLIB_API__ double log (x) double x;
{
    int i,scale;
...
__PDPCLIB_API__ double log10(x) double x;
{
    return ( log(x) / ln10 );
}
...
__PDPCLIB_API__ double pow(x,y) double x; double y;
{
    int j,neg;
    double yy,xx;
    neg=0;
...
__PDPCLIB_API__ double sqrt(x) double x;
{
    double xs,yn,ynn;
    double pow1;
    int i;
...
__PDPCLIB_API__ double frexp(x, exp) double x; int *exp;
{
/*
...
__PDPCLIB_API__ double ldexp(x, exp) double x; int exp;
{
/*
  note this is not so easy for IBM as it uses HEX float
*/
...
__PDPCLIB_API__ double modf(value, iptr) double value; double *iptr;
{
    int neg = 0;
    long i;
